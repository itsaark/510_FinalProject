...
nClustSet = [2 3 5 8 10];
%nClust = 3;

for i = 1:length(nClustSet)
    nClust = nClustSet(i);
    s = [];
    ...
    [estLabels, _] = mySpectralClustering(W,nClust,1);
    [estLabels2, _] = mySpectralClustering(W2,nClust,1);
    
    s = s';
    disp(['nclusters=' num2str(nClust)])
